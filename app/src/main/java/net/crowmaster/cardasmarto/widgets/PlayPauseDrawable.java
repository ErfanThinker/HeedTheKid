...
public class PlayPauseDrawable extends Drawable {
    ...
    public PlayPauseDrawable() {
        this(5, 0XFFFFFFFF, 0XFFFFFFFF, 0X00000000, 300);
    }

    public PlayPauseDrawable(int strokeWidth, int playColor, int pauseColor, int backgroundColor, long animationDuration) {
    ...
    private Property<PlayPauseDrawable, Integer> mBackgroundColorProperty = new Property<PlayPauseDrawable, Integer>(Integer.class, "bg_color") {
        ...
        public void set(PlayPauseDrawable object, Integer value) {
            object.mBackgroundPaint.setColor(Color.parseColor("#00000000"));
        }
    };
